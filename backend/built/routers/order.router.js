...
var order_status_1 = require("../constans/order_status");
...
router.post('/create', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var requestOrder, items, newOrder;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                items = requestOrder.items.map(function (item) { return ({
                    food: item.food,
                    price: item.price,
            ...
            case 1:
                _a.sent();
                newOrder = new order_model_1.OrderModel(__assign(__assign({}, requestOrder), { user: req.user.id, items: items }));
